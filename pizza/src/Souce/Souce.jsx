...
import style from "../Souce/Souce.module.css";
import {NavLink} from "react-router-dom";

const Souce=(props)=>{

    let c=0;
    let souce= props.souce.img.map(i=>{return(<div key={i.name} className={style.diva}><div className={style.wpapper}>
    ...
    return(
        <div>
            <div className={style.razdely}>
                <h1 className={style.headPizza}>Соусы</h1>
            </div>
