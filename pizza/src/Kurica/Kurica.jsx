...
import style from "../Kurica/Kurica.module.css";
...
const Kurica = (props) => {
    ...
    let kurica = props.kurica.img.map(i => {
        return (<div key={i.name} className={style.diva}>
    ...
    return (
        <div>
            <div className={style.razdely}>
                <h1 className={style.headPizza}>Курица</h1>
            </div>
