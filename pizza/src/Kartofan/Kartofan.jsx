...
import style from "./Kartofan.module.css";
import {NavLink} from "react-router-dom";

const Kartofan=(props)=>{

    let c=0;
    let kartofan= props.kartofan.img.map(i=>{return(<div key={i.name} className={style.diva}><div className={style.wpapper}>
    ...
    return(
        <div>
            <div className={style.razdely}>
                <h1 className={style.headPizza}>Картофель</h1>
            </div>
