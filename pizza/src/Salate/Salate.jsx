...
import style from "../Salate/Salate.module.css";
import {NavLink} from "react-router-dom";

const Salate=(props)=>{

    let c=0;
    let salate= props.salate.img.map(i=>{return(<div key={i.name} className={style.diva}><div className={style.wpapper}>
    ...
    return(
        <div>
            <div className={style.razdely}>
                <h1 className={style.headPizza}>Салаты</h1>
            </div>
